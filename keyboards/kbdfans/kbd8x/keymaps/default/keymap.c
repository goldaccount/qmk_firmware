...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_all(
      ...
      KC_LCTL, KC_LGUI, KC_LALT,         KC_SPC,                 KC_LGUI, KC_RGUI, KC_MENU, KC_RCTL,                            KC_LEFT, KC_DOWN, KC_RGHT),

    [1] = LAYOUT_all(
      BL_TOGG,  BL_INC,  BL_DEC, BL_BRTG, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                    KC_TRNS, KC_NLCK, KC_TRNS, \
